...
const StoryBox = ({ f }: StoryBoxProps) => {
  ...
  const [comment5, setComment5] = useState<string>("");
  const [comment6, setComment6] = useState<string>("");
    ...
    <StoryBoxRoot>
      ...
      <GenRoot>
        <Box>
          ...
          <Story>
            <p>
              형석과 선씨의 둘째 아들, 락민이 1917년 정월 10일에 태어난다.
              락민은{" "}
              <a
              ...
              아버지의 성함은 김윤석이다. 락민는 1949년 5월 13일에 생을
              마감하고,{" "}
              <a
          ...
          <Story>
            <p>
              형석과 선씨의 셋째 아들, 락현이 1926년 2월 18일에 태어난다. 락현은{" "}
              <a
              ...
              와 결혼한다. 배우자인 배씨는 1924년 9월 5일에 태어났으며, 아버지의
              성함은 배평학이다. 락현은 1959년 8월 7일에 생을 마감하고,{" "}
              <a
                href="https://www.google.com/maps/place/%EA%B2%BD%EA%B8%B0%EB%8F%84+%EC%88%98%EC%9B%90%EC%8B%9C+%EA%B6%8C%EC%84%A0%EA%B5%AC+%ED%83%91%EB%8F%99/data=!4m2!3m1!1s0x357b428a61d2cf27:0x296fe9e040b1b8bf?sa=X&ved=2ahUKEwi94-LVxNWDAxVxm1YBHbmJBpcQ8gF6BAgTEAA"
                target="_blank"
              >
      ...
      <GenRoot>
        <Box>
          <Story>
            <p>
              락성과 임씨의 첫째 아들, 두석이 1939년 2월 28일에 태어난다. 두석은{" "}
              <a
          ...
          <Story>
            <p>
              락성과 임씨의 둘째 아들, 두락이 1945년 10월 18일에 태어난다.
              두락은{" "}
              <a
          ...
          <Story>
            <p>
              락성과 임씨의 셋째 아들, 두현이 1948년 2월 15일에 태어난다.
              중앙대학교 신문방송학과를 졸업하고, 국가경찰공무원을 정년퇴직한다.
              대통령 표창장 제133613호와 대한민국{" "}
              <a
          ...
          <Story>
            <p>
              락성과 임씨의 넷째 아들, 두경이 1951년 7월 9일에 태어난다. 두경은{" "}
              <a
          ...
          <Story>
            <p>
              락민과 안영의 아들, 경민이 1947년 정월 26일에 태어난다. 경민은{" "}
              <a
      ...
      <GenRoot>
        <Box>
          <Story>
            <p>
              두석과 옥순의 첫째 딸, 수미가 1965년 12월 3일에 태어난다.
              한성대학교를 졸업했다고 기록되어 있지만 사실이 아닌 듯하다.
            </p>
          </Story>
          <Story>
            <p>
              두석과 옥순의 아들, 현우가 1969년 8월 18일 서울에서 태어난다.
          ...
          <Story>
            <p>
              두석과 옥순 둘째 딸, 현정이 1973년 4월 23일에 태어난다.
              한양대학교를 졸업했다고 기록되어 있지만 사실이 아닌 듯하다.
            </p>
          </Story>
          <Story>
            <p>
              두석과 옥순 셋째 딸, 수현이 1976년 8월 14일에 태어난다.
              상명대학교를 졸업했다.
            </p>
          </Story>
          <Story>
            <p>
              두락과 경자의 아들, 준필이 1986년 6월 26일에 태어난다. 연세대학교
              방송학과를 졸업했다.
            </p>
          </Story>
          <Story>
